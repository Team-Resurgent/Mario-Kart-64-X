...
u8* dma_copy_base_misc_textures(u8* devAddr, u8* baseAddress, u32 size, UNUSED u32 offset) {
    size = ALIGN16(size);
...
extern uint8_t __attribute__((aligned(32))) backing_gCourseOutline[OUTLINE_BUF_COUNT][OUTLIZE_BUF_SIZE];
