...
void init_red_shell_texture(void) {
    ...
    // Derive from the SEGMENT copy of the green palette (ROM-true BE), same
    // source the shell renders now load from -- see render_actor_green_shell.
    u16* green_shell_texture = (u16*) segmented_to_virtual((void*) 0x0D004E38);
#else
