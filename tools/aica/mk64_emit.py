...
def main(audiobanks, audiotables, outdir, incdir, pool_path):
    ...
    # newline="\n": write_text uses text mode, which turns every \n into \r\n
    # on Windows. These two files are tracked, so a CRLF rewrite makes them
    # show as modified after every single build even though nothing changed.
