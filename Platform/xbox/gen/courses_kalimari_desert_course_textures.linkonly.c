/* Generated wrapper: gives courses/kalimari_desert/course_textures.linkonly.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/kalimari_desert/course_textures.linkonly.c"
