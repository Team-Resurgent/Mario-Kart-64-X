/* Generated wrapper: gives courses/choco_mountain/course_textures.linkonly.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/choco_mountain/course_textures.linkonly.c"
