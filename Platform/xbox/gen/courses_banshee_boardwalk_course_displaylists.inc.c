/* Generated wrapper: gives courses/banshee_boardwalk/course_displaylists.inc.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/banshee_boardwalk/course_displaylists.inc.c"
