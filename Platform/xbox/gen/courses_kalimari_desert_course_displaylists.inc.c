/* Generated wrapper: gives courses/kalimari_desert/course_displaylists.inc.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/kalimari_desert/course_displaylists.inc.c"
