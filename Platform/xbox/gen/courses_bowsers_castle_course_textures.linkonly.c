/* Generated wrapper: gives courses/bowsers_castle/course_textures.linkonly.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/bowsers_castle/course_textures.linkonly.c"
