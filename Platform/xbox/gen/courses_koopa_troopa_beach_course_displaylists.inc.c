/* Generated wrapper: gives courses/koopa_troopa_beach/course_displaylists.inc.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/koopa_troopa_beach/course_displaylists.inc.c"
