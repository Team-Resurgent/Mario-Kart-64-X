/* Generated wrapper: gives courses/frappe_snowland/course_displaylists.inc.c a unique object name.
 ...
 * own directory. */
#include "../../../courses/frappe_snowland/course_displaylists.inc.c"
